export const digitalCardData = {
  company: {
    name: "Ansely",
    tagline: "Entering the Digital World Together",
    logo: "/logo.png",
  },
  founder: {
    name: "Geerthanan",
...
export const digitalCardDataDamien = {
  company: {
    name: "Ansely",
...
export const digitalCardDatajosh = {
  company: {
...
export const digitalCardDataBurnsHairDesign = {
  company: {
    name: "Burns Hair Design",
    tagline: "Hair Services and Color Services",
...
export const digitalCardDataMehranGarages = {
  ...
  about: "Professional automotive repair services that restore your vehicle to perfect condition.",
    services: [
      ...
      { label: "Tyre & Alignment", href: "https://mehransgarage.co.uk/services/tyre-alignment" },
      { label: "Clutch Repair", href: "https://mehransgarage.co.uk/services/clutch" },
      { label: "Timing Systems", href: "https://mehransgarage.co.uk/services/timing-system" },
      { label: "Fleet Management", href: "https://mehransgarage.co.uk/services/fleet-management" },
      { label: "Commercial Van Repair", href: "https://mehransgarage.co.uk/services/commercial-van" },
    ],
  rating: {
    value: "5.0",
...
export const digitalCardDataCenturion = {
  ...
  contacts: [
    ...
    services: [
      { label: "MOT & Car Servicing", href: "https://centurionfastfit.uk/service/mot" },
      { label: "Tyres", href: "https://centurionfastfit.uk/service/tyre" },
      { label: "Smart Repairs", href: "https://centurionfastfit.uk/service/smart-repair" },
      { label: "OEM Diagnostic Tools", href: "https://centurionfastfit.uk/service/oem" },
      { label: "Ghost Immobiliser Fitting", href: "https://centurionfastfit.uk/service/ghost" },
      { label: "Shock Absorbers & Suspension", href: "https://centurionfastfit.uk/service/shock" },
      { label: "Coventry Exhausts", href: "https://centurionfastfit.uk/service/exhausts" },
      { label: "Brake Discs & Brake Pads", href: "https://centurionfastfit.uk/service/brake" },
      { label: "Car Batteries", href: "https://centurionfastfit.uk/service/battery" },
      { label: "Clutch Fitting", href: "https://centurionfastfit.uk/service/clutch" },
      { label: "Timing Belt Fitting Service", href: "https://centurionfastfit.uk/service/timing-belt" },
      { label: "Aircon Re-gas & Repairs", href: "https://centurionfastfit.uk/service/aircon" },
      { label: "Vehicle Safety Assessments", href: "https://centurionfastfit.uk/service/vehicle-safety" },
    ],
  rating: {
    value: "5.0",
