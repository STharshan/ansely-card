...
import { digitalCardData ,downloadVCF } from "../data/nandjmotcentre/nandjmotcentre.js";
...
const iconMap = { Phone, Globe, MapPin, Mail };

export default function Nandjmotcentre() {
    ...
    <main className="relative min-h-screen text-white flex justify-center bg-[var(--bg-main)]">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <header className="w-full max-w-md px-6 pt-16 pb-6 flex flex-col items-center justify-center gap-5 text-center">
            ...
            {logoFailed ? (
              <div className="relative flex w-28 h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-3xl font-black tracking-[0.16em] text-white">N&amp;J</div>
          ...
          <h1
            className="text-[2.35rem] font-bold uppercase leading-[0.95] tracking-[0.08em] text-white drop-shadow-lg sm:text-[2.75rem]"
