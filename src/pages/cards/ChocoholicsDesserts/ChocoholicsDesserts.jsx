...
import { digitalCardDataChocoholicsDesserts } from "../../../global";
import { downloadVCF } from "./ChocoholicsDesserts.js";
...
const iconMap = { Phone, Mail, Globe, Facebook: FaFacebook, TikTok: FaTiktok };

export default function ChocoholicsDesserts() {
    const {
        company,
        founder,
        contacts,
        ...
        ratingUrl,
        socialLinks,
    } = digitalCardDataChocoholicsDesserts;
    ...
    return (
                    ...
                    <div className="relative shrink-0">
                        <div className="absolute inset-0 blur-2xl rounded-full scale-110" />
                            <img
                                ...
                                alt={founder.name}
                                loading="lazy"
                                className="relative object-cover w-30 h-20 md:w-38 md:h-24"
                            />
                    </div>
                    <h1
        ...
        */}
                <div className="w-full max-w-md px-4 pb-20">
                    ...
                    {/* Services */}
                    <section className="mb-10">
                        <h3 className="text-lg font-semibold mb-4 text-center">Main Menu</h3>
