...
import { digitalCardDataShahzTyres } from "../../../global";
import { downloadVCF } from "./Shaz.js";
...
const iconMap = { Phone, MessageCircle, Mail, Globe, Facebook: FaFacebook, TikTok: FaTiktok };

export default function ShahzTyres() {
    const {
        company,
        founder,
        contacts,
