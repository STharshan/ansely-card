...
import { digitalCardDataCommit } from "../../../global";
import { downloadVCF } from "./Commit.js";
    ...
    return (
         ...
         */}
                <div className="w-full max-w-md px-4 pb-20">
                    ...
                    {/* Services */}
                    <section className="mb-10">
                        <h3 className="text-lg font-semibold mb-4 text-center">Our Facility</h3>
