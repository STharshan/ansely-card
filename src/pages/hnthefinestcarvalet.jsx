...
import { digitalCardData ,downloadVCF } from "../data/hnthefinestcarvalet/hnthefinestcarvalet.js";
...
export default function Hnthefinestcarvalet() {
            ...
            {logoFailed || !company.logo ? (
              <div className="relative flex w-20 h-20 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">HN</div>
              ...
              <div className="relative flex w-36 h-24 md:w-44 md:h-28 items-center justify-center overflow-hidden rounded-3xl bg-slate-950/75 p-2 shadow-2xl shadow-black/40 ring-1 ring-cyan-300/15 backdrop-blur-sm">
                <img
                  src={company.logo}
                  alt={company.name}
                  loading="lazy"
                  onError={() => setLogoFailed(true)}
                  className="h-full w-full scale-125 object-contain drop-shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
                />
              </div>
            )}
          </div>
