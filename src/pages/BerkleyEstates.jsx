...
import { digitalCardData ,downloadVCF } from "../data/BerkleyEstates/BerkleyEstates.js";
...
const iconMap = { Phone, Mail, Globe, MapPin, Instagram, Facebook, Linkedin };

export default function BerkleyEstates() {
            ...
            {logoFailed ? (
              <div className="relative flex w-28 h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-3xl font-black tracking-[0.12em] text-white">BE</div>
