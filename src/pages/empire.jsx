...
import { digitalCardData ,downloadVCF } from "../data/empire/empire.js";
    ...
    <main className="relative min-h-screen text-white flex justify-center bg-[var(--bg-main)]">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <header className="w-full max-w-md px-4 pt-16 pb-6 flex items-center justify-center gap-3 md:gap-8">
            ...
            {logoFailed ? (
              <div className="relative flex w-20 h-20 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">EMP</div>
          ...
          <h1
            className="min-w-0 text-[1.45rem] leading-tight md:text-5xl font-bold tracking-[0.05em] md:tracking-[0.08em] text-white uppercase drop-shadow-lg"
