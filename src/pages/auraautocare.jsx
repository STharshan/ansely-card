...
import { digitalCardData, downloadVCF } from "../data/auraautocare/auraautocare.js";
...
export default function Auraautocare() {
        ...
        <header className="w-full max-w-md px-4 pt-16 pb-6 flex flex-col items-center justify-center gap-5 text-center">
          <div className="relative shrink-0">
            ...
            {logoFailed ? (
              ...
              <div className="relative flex w-24 h-24 md:w-32 md:h-32 items-center justify-center rounded-3xl p-1 shadow-2xl shadow-black/30">
                <img
                  src={company.logo}
                  alt={company.name}
                  loading="lazy"
