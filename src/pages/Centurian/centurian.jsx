...
import { digitalCardDataCenturion } from "../../global";
import { downloadVCF } from "./centurian.js";
...
export default function CenturionFastFit() {
    const {
        company,
        founder,
        contacts,
                ...
                <header className="w-full max-w-md px-6 pt-16 pb-6 flex flex-col md:flex-row items-center justify-center gap-5 md:gap-8 text-center md:text-left">
                    <div className="relative shrink-0">
                        ...
                        <img
                            ...
                            alt={founder.name}
                            loading="lazy"
                            className="relative object-cover w-48 h-20 md:w-45 md:h-20"
                        />
                    </div>
                    <h1
                        className="text-4xl md:text-4xl font-bold tracking-[0.25em] text-white uppercase drop-shadow-lg"
