            ...
            {logoFailed ? (
              <div className="relative flex w-20 h-20 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  ...
                  <div className="mt-1 text-[0.48rem] md:text-[0.58rem] font-semibold uppercase tracking-[0.2em] text-blue-200">
                    Detailing
                  </div>
                </div>
              </div>
        ...
        <div className="w-full max-w-md px-4 pb-20">
              ...
              {services.map((service) => (
                <li key={service.label}>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex text-center justify-center items-center rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-white transition hover:border-blue-300/40 hover:bg-white/8"
                  >
          ...
          {rating ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="block rounded-xl p-6 text-center mb-10 border border-white/10 bg-white/5 backdrop-blur-md transition hover:border-blue-300/40 hover:bg-white/8"
            >
          ...
          {locationHref ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex justify-center items-center gap-2 text-white mb-10 hover:text-blue-300 transition text-center"
            >
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="h-12 w-12 rounded-full flex items-center justify-center transition bg-white/10 hover:bg-[#486AAB]"
                  >
                    <IconComponent className="w-5 h-5" />
                  </a>
                );
          ...
          <section className="mb-10">
            <button
              onClick={downloadVCF}
              className="w-full h-14 flex items-center justify-center gap-2 rounded-lg font-semibold bg-[#486AAB] transition-all hover:bg-[#6E96E7]"
            >
          ...
          <footer className="text-center text-sm text-gray-400 opacity-60">
            <p>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-white transition hover:text-blue-300 hover:underline"
              >
                Ansely
              </a>
            </p>
