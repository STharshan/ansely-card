...
import { digitalCardData ,downloadVCF } from "../data/ttautosgarage/ttautosgarage.js";
...
export default function Ttautosgarage() {
            ...
            {logoFailed ? (
              <div className="relative flex w-28 h-28 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">TT</div>
