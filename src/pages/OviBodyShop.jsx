...
import { digitalCardData ,downloadVCF } from "../data/OviBodyShop/ovibodyshop.js";
...
export default function OviBodyShop() {
    ...
    <main className="relative min-h-screen text-white flex justify-center bg-[var(--bg-main)]">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <header className="w-full max-w-md px-4 pt-16 pb-6 flex flex-col items-center justify-center gap-4 text-center md:flex-row md:gap-8 md:text-left">
            ...
            {logoFailed ? (
              <div className="relative flex w-20 h-20 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">OVI</div>
          ...
          <h1
            className="max-w-[11ch] min-w-0 text-[1.3rem] font-bold uppercase leading-tight tracking-[0.06em] text-white drop-shadow-lg md:max-w-none md:text-5xl md:tracking-[0.12em]"
        ...
        */}
        <div className="w-full max-w-md px-4 pb-20">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex justify-center items-center gap-2 text-white mb-10 hover:text-cyan-300 transition whitespace-nowrap text-sm md:text-base"
          >
