...
import { digitalCardData ,downloadVCF } from "../data/YorkshireInsulation/YorkshireInsulation.js";
...
export default function YorkshireInsulation() {
    ...
    <main className="relative min-h-screen text-white flex justify-center bg-[var(--bg-main)]">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <header className="w-full max-w-md px-6 pt-16 pb-6 flex flex-col items-center justify-center gap-4 text-center md:flex-row md:gap-8 md:text-left">
            ...
            {logoFailed ? (
              <div className="relative flex w-28 h-28 md:w-28 md:h-28 items-center justify-center rounded-3xl border border-white/10 bg-slate-950 shadow-2xl">
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">YI</div>
          ...
          <h1
            className="max-w-[11ch] text-[1.85rem] font-bold uppercase leading-tight tracking-[0.08em] text-white drop-shadow-lg md:max-w-none md:text-5xl"
