...
import { digitalCardData ,downloadVCF } from "../data/dynamicvehicleservices/dynamicvehicleservices.js";
          ...
          <div className="relative shrink-0">
            ...
            {logoFailed ? (
                ...
                <div className="text-center leading-none">
                  <div className="text-2xl md:text-3xl font-black tracking-[0.18em] text-white">DVS</div>
